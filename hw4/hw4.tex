...
\begin{table}[htbp]
  ...
  \begingroup\let\small\scriptsize\makebox[\textwidth][c]{\input{../hw4_code/output/fit_covariance_matrix_budesonide.tex}}\endgroup
\end{table}
...
\begin{table}[htbp]
  ...
  \begingroup\let\small\scriptsize\makebox[\textwidth][c]{\input{../hw4_code/output/fit_covariance_matrix_nedocromil.tex}}\endgroup
\end{table}
...
\begin{table}[htbp]
  ...
  \begingroup\let\small\scriptsize\makebox[\textwidth][c]{\input{../hw4_code/output/fit_covariance_matrix_placebo.tex}}\endgroup
\end{table}
